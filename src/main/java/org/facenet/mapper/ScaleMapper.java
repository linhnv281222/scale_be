...
public class ScaleMapper {
    ...
    public static ScaleDto.Response toResponseDto(Scale scale) {
        ...
        return ScaleDto.Response.builder()
                ...
                .manufacturerId(scale.getManufacturer() != null ? scale.getManufacturer().getId() : null)
                .manufacturerName(scale.getManufacturer() != null ? scale.getManufacturer().getName() : null)
                .manufacturerCode(scale.getManufacturer() != null ? scale.getManufacturer().getCode() : null)
                .protocolId(scale.getProtocol() != null ? scale.getProtocol().getId() : null)
                .protocolName(scale.getProtocol() != null ? scale.getProtocol().getName() : null)
                .protocolCode(scale.getProtocol() != null ? scale.getProtocol().getCode() : null)
                .model(scale.getModel())
                .direction(scale.getDirection() != null ? scale.getDirection().name() : null)
